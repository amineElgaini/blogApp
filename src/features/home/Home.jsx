...
function Home() {
    return (
        <>
            <div style={{height: 'calc(100vh - 60px)'}} className="flex justify-center items-center relative after:content-[''] after:left-0 after:top-0 after:absolute after:w-full after:h-full after:bg-black/60 after:z-1">
